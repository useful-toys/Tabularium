...
decisao: Documento de produto e, quando houver estrutura relevante, modelo conceitual lido sempre junto, ambos densos em listas aninhadas
carregar-quando: mudança na estrutura, nas seções, nos arquivos ou na forma de escrever a descrição do produto
---
- Decisão: o produto é descrito no documento de produto, nesta ordem: o que é, diferenciais, glossário, requisitos por domínio (requisito com regras em sub-itens), regras transversais, não funcionais, fora de escopo; e, quando o domínio tem estrutura relevante, também no modelo conceitual, que existindo é lido sempre junto com o documento de produto
...
- Consequências
  - Ganha: leitura completa em até dois arquivos pequenos, com a estrutura explícita
  - Aceita: dois arquivos a manter coerentes pelo vocabulário do glossário

## Histórico
- 2026-09-24 #1: produto ganha o modelo conceitual, lido junto quando existe; arquivo renomeado de documento-de-produto-unico
