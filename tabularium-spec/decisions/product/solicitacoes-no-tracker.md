...
---
- Decisão: ideias e solicitações guardadas vivem no GitHub Issues; ideias adiadas viram issues de requisito na milestone `v2`; resumos de amadurecimento vão para a issue a pedido; análise de impacto e revisão ficam em comentários da issue e do PR; o repositório não guarda planos, só o documento de produto e as decisões aceitos
...
- Alternativas descartadas
  ...
  - Seção de requisitos futuros (v2) no documento de produto: gasta tokens do contexto permanente com algo muito improvável de ser usado, que não informa as decisões do agente
...
## Histórico
- 2026-09-24 #7: tracker só GitHub Issues; ideias adiadas em milestone no tracker; Jira descartado
